...
public class LoadGen01 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        DOSAttack ddos = new DOSAttack(1, 20);
        Thread.sleep(20000);
        ddos.stop();
        System.out.println("Step 2");
        ddos = new DOSAttack(1, 500);
        Thread.sleep(10000);
        ddos.stop();
        System.out.println("Step 3");
        ddos = new DOSAttack(1, 1000);
        Thread.sleep(10000);
        ddos.stop();
        System.out.println("Step 4");
        ddos = new DOSAttack(1, 2000);
        Thread.sleep(20000);
        ddos.stop();

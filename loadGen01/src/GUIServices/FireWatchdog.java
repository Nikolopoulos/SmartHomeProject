 ...
 * @author billaros
 */
public class FireWatchdog extends javax.swing.JFrame {

    /**
     * Creates new form FireWatchdog
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hector the Fire Watchdog");

        jLabel2.setText("Temperature levels:");

        jLabel3.setText("CO2 levels:");

        jLabel4.setText("Light levels:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FireWatchdog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FireWatchdog().setVisible(true);
            }
        });
    }

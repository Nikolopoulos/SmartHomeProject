 ...
 * This class implements a Java interface to the 'Switch_Answer'
 * message type.
 */

public class Switch_Answer extends net.tinyos.message.Message {
    ...
    /** Create a new Switch_Answer of size 6. */
    public Switch_Answer() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new Switch_Answer of the given data_length. */
    public Switch_Answer(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Switch_Answer with the given data_length
     * and base offset.
     */
    public Switch_Answer(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Switch_Answer using the given byte array
     * as backing store.
     */
    public Switch_Answer(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public Switch_Answer(byte[] data, int base_offset) {
     ...
     */
    public Switch_Answer(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Switch_Answer embedded in the given message
     * at the given base offset.
     */
    public Switch_Answer(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public Switch_Answer(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <Switch_Answer> \n";
      try {

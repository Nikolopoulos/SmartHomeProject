 ...
 * This class implements a Java interface to the 'Switch_Toggle'
 * message type.
 */

public class Switch_Toggle extends net.tinyos.message.Message {

    /** The default size of this message type in bytes. */
    public static final int DEFAULT_MESSAGE_SIZE = 4;

    /** The Active Message type associated with this message. */
    public static final int AM_TYPE = 21;

    /** Create a new Switch_Toggle of size 4. */
    public Switch_Toggle() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new Switch_Toggle of the given data_length. */
    public Switch_Toggle(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Switch_Toggle with the given data_length
     * and base offset.
     */
    public Switch_Toggle(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Switch_Toggle using the given byte array
     * as backing store.
     */
    public Switch_Toggle(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public Switch_Toggle(byte[] data, int base_offset) {
     ...
     */
    public Switch_Toggle(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new Switch_Toggle embedded in the given message
     * at the given base offset.
     */
    public Switch_Toggle(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public Switch_Toggle(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <Switch_Toggle> \n";
      try {

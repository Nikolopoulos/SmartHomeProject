...
#include "../../eudemo/HTTPServer/connectionhandler.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_connectionHandler_t, stringdata) + ofs \
...
const QMetaObject connectionHandler::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_connectionHandler.data,
      qt_meta_data_connectionHandler,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_connectionHandler.stringdata))
        return static_cast<void*>(const_cast< connectionHandler*>(this));

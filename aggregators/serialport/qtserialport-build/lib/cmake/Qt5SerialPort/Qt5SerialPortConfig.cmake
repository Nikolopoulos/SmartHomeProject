...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5SerialPort" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5SerialPort_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5SerialPort_VERSION_STRING 5.3.2)
...
macro(_populate_SerialPort_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5SerialPort_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::SerialPort)
    ...
    set(_Qt5SerialPort_OWN_INCLUDE_DIRS "${_qt5SerialPort_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5SerialPort_install_prefix}/include/x86_64-linux-gnu/qt5/QtSerialPort")
    set(Qt5SerialPort_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialPort_install_prefix}/include/x86_64-linux-gnu/qt5/QtSerialPort/5.3.2"
        "${_qt5SerialPort_install_prefix}/include/x86_64-linux-gnu/qt5/QtSerialPort/5.3.2/QtSerialPort"
    )
    ...
    foreach(_module_dep ${_Qt5SerialPort_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.3.2 ${_Qt5SerialPort_FIND_VERSION_EXACT}
    ...
    _populate_SerialPort_target_properties(RELEASE "libQt5SerialPort.so.5.3.2" "" )
    ...
    macro(_populate_SerialPort_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5SerialPort_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_SerialPort_check_file_exists(${imported_location})
